...
const ThermistorData thermistor_table[] = {
    {20.0f, 126800.0f, 150.0f, 1360.0f, 300.0f, 80.7f},
    {25.0f, 100000.0f, 160.0f, 1074.0f, 300.0f, 82.8f},
    {25.0f, 100000.0f, 150.0f, 1641.9f, 250.0f, 226.2f},
    {25.0f, 100000.0f, 150.0f, 1770.0f, 250.0f, 230.0f},
    {25.0f, 500000.0f, 200.0f, 3734.0f, 400.0f, 240.0f},
    {25.0f, 100000.0f, 50.0f, 31230.0f, 125.0f, 2066.0f}
};
